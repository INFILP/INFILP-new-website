...
//     // When mobile menu is open, use default colors (white text)
//     const shouldUseScrollColors = isScrolled && !isMenuOpen;
...
//     // When mobile menu is open, use default colors (white)
//     const shouldUseScrollColors = isScrolled && !isMenuOpen;
...
//     <>
//       <nav
//         className={`fixed top-0 left-0 right-0 z-[9999] px-4 sm:px-6 transition-all duration-300 ${
...
//   const getLinkClasses = (href, baseClasses) => {
//     const isActive = isActiveLink(href);
//     // For home page: use scroll-based colors, for other pages: always use white background colors
...
//   const getHamburgerClasses = () => {
//     // For home page: use scroll-based colors, for other pages: always use black
//     const shouldUseScrollColors = isHomePage ? isScrolled && !isMenuOpen : true;
//     return `w-6 h-0.5 transition-all duration-200 ${
//       shouldUseScrollColors ? "bg-black" : "bg-white"
//     }`;
...
const Header = () => {
  ...
  // Determine navbar background
  const getNavbarBackground = () => {
    // When mobile menu is open, always use black background
    if (isMenuOpen) {
