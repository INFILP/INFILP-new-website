...
const BuildBanner = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative bg-gradient-to-r bg-gradient-seeCard rounded-tl-2xl rounded-br-2xl px-6 py-8 md:px-12 md:py-12 flex flex-col items-center justify-center text-center shadow-xl overflow-hidden"
      ...
      >
        ...
        <div className="relative z-10 space-y-4">
          {/* Top text */}
          <motion.p
            className="text-white text-[15px] md:text-[28px] font-Manrope-regular opacity-90"
          ...
          {/* Main text */}
          <motion.h2
            className="text-white text-[21px] md:text-4xl lg:text-[58px] font-Manrope-bold leading-tight"
            initial={{ opacity: 0, y: 20 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
            transition={{ duration: 0.6, delay: delay + 0.4 }}
          >
            Ready to build{" "}
            <span className="font-Manrope-regular">something great?</span>
          </motion.h2>
